...
import { Send, CheckCircle, AlertCircle, ArrowUpCircle } from "lucide-react";
...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="container mx-auto max-w-7xl px-4 py-20 md:px-8 scroll-m-16"
    >
      ...
      <div className="mt-16 flex justify-center">
        <Link
          href="#home"
          className="group flex flex-col items-center text-yellow-400 transition-all duration-300 hover:text-yellow-300"
          aria-label="Scroll back to top"
        >
          <ArrowUpCircle className="h-10 w-10 transition-transform duration-300 group-hover:-translate-y-1" />
          <span className="mt-2 text-sm font-medium">Back to Top</span>
        </Link>
      </div>
    </section>
  );
